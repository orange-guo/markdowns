...
> 此文章为`Rich Hickey`在2011年`Strange Loop`大会上的演讲的演讲的笔记, 主要讲述了`Simple`和`Easy`的区别，以及如何在软件开发中做到`Simple`.<br/>

<iframe width="560" height="315" src="https://www.youtube.com/embed/LKtk3HCgTa8" title="YouTube video player"
		frameborder="0"
		allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
		allowfullscreen></iframe>

> Simplicity is prerequisite for reliability. - Edsger W. Dijkstra<br/>简单是可靠的前提. - Edsger W. Dijkstra
