...
- [deban wiki](https://wiki.debian.org/)
...
- [awesome-os](https://github.com/zriyansh/awesome-os)
  <br/>A collection of all big and small open-source clones of Linux, Windows, and macOS operating system and their software.
