...
tags: [ docusaurus, react, mdx, asciinema ]
---
...
```css title="src/components/asciinema/react/asciinema-player.css"
div.ap-wrapper {
	outline: none;
	height: 100%;
	display: flex;
...
.asciinema-player-theme-docusaurus-classic-light {
	--term-color-foreground: rgb(16, 36, 69); /* Dark gray for foreground text */
	--term-color-background: #fff; /* White background for light theme */
	--term-color-0: #f6f8fa; /* Very light gray */
	--term-color-1: #e34c26; /* Red */
	--term-color-2: #28a745; /* Green */
	--term-color-3: #ffd33d; /* Yellow */
	--term-color-4: #0366d6; /* Blue */
	--term-color-5: #6f42c1; /* Purple */
	--term-color-6: #17a2b8; /* Cyan */
	--term-color-7: #586069; /* Medium gray */
	--term-color-8: #6a737d; /* Light medium gray */
	--term-color-9: #d73a49; /* Bright red */
	--term-color-10: #34d058; /* Bright green */
	--term-color-11: #ffea7f; /* Bright yellow */
	--term-color-12: #2188ff; /* Bright blue */
	--term-color-13: #b392f0; /* Bright purple */
	--term-color-14: #39c0ed; /* Bright cyan */
	--term-color-15: #1b1f23; /* Dark gray */
}
.asciinema-player-theme-docusaurus-classic-light .ap-overlay-start .ap-play-button svg .ap-play-btn-fill {
	fill: var(--term-color-1);
}
.asciinema-player-theme-docusaurus-classic-light .ap-overlay-start .ap-play-button svg .ap-play-btn-stroke {
	stroke: var(--term-color-1);
}

.asciinema-player-theme-docusaurus-classic-dark {
	--term-color-foreground: rgb(235, 242, 252); /* Light gray for foreground text */
	--term-color-background: #1b1b1d; /* Very dark background */
	--term-color-0: #161b22; /* Dark gray */
	--term-color-1: #f85149; /* Red */
	--term-color-2: #3fb950; /* Green */
	--term-color-3: #d29922; /* Yellow */
	--term-color-4: #58a6ff; /* Blue */
	--term-color-5: #bc8cff; /* Purple */
	--term-color-6: #39c5cf; /* Cyan */
	--term-color-7: #8b949e; /* Medium gray */
	--term-color-8: #6e7681; /* Dark medium gray */
	--term-color-9: #ff7b72; /* Bright red */
	--term-color-10: #56d364; /* Bright green */
	--term-color-11: #e3b341; /* Bright yellow */
	--term-color-12: #79c0ff; /* Bright blue */
	--term-color-13: #d2a8ff; /* Bright purple */
	--term-color-14: #56d4dd; /* Bright cyan */
	--term-color-15: #f0f6fc; /* Very light gray (almost white) */
}
```
...
```ts title="src/components/asciinema/docusaurus/markdown.ts"
